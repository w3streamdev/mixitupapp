...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    setConnectUrl(
      `${apiUrl}/api/v2/auth/twitch/connect?redirect_uri=${encodeURIComponent(redirectUri)}`,
    );
  }, [apiUrl]);
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-xl border border-surface-800 bg-surface-850 p-8">
          ...
          {connectUrl ? (
            ...
            <div className="w-full py-3 rounded-lg bg-surface-700 text-slate-400 text-center">
              Loading...
            </div>
          )}
