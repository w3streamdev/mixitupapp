        ...
        public static readonly IEnumerable<TextToSpeechVoice> AvailableVoices = new List<TextToSpeechVoice>()
{
    ...
    new TextToSpeechVoice("fr_002", "French - Male 2"),
    ...
    new TextToSpeechVoice("en_female_madam_leota", "Madam Leota"),
    new TextToSpeechVoice("en_male_ghosthost", "Ghost Host"),
    new TextToSpeechVoice("en_male_pirate", "Pirate"),
